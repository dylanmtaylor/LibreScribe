...
GUIFrame::GUIFrame(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	renameSmartpenMenuItem = new wxMenuItem((&rootItemMenu), idRootItemMenuRenameDevice, _("Rename Smartpen"), _("Change the name of the connected smartpen"), wxITEM_NORMAL);
	...
	//*)
	printf("LibreScribe Alpha version 0.20, written by Dylan Taylor\n");
