...
out_Debug: $(OBJ_DEBUG) $(DEP_DEBUG)
	$(LDFLAGS_DEBUG) $(LIBDIR_DEBUG) $(OBJ_DEBUG) $(LIB_DEBUG) -o $dynamic_output

$(OBJDIR_DEBUG)/DeviceInfo.o: DeviceInfo.cpp
	$(CFLAGS_DEBUG) $(INC_DEBUG) -c DeviceInfo.cpp -o $(OBJDIR_DEBUG)/DeviceInfo.o

$(OBJDIR_DEBUG)/GUIFrame.o: GUIFrame.cpp
	$(CFLAGS_DEBUG) $(INC_DEBUG) -c GUIFrame.cpp -o $(OBJDIR_DEBUG)/GUIFrame.o

$(OBJDIR_DEBUG)/LibreScribe.o: LibreScribe.cpp
	$(CFLAGS_DEBUG) $(INC_DEBUG) -c LibreScribe.cpp -o $(OBJDIR_DEBUG)/LibreScribe.o

$(OBJDIR_DEBUG)/src/BackgroundMonitor.o: src/BackgroundMonitor.cpp
	$(CFLAGS_DEBUG) $(INC_DEBUG) -c src/BackgroundMonitor.cpp -o $(OBJDIR_DEBUG)/src/BackgroundMonitor.o

$(OBJDIR_DEBUG)/src/Smartpen.o: src/Smartpen.cpp
	$(CFLAGS_DEBUG) $(INC_DEBUG) -c src/Smartpen.cpp -o $(OBJDIR_DEBUG)/src/Smartpen.o
...
out_Release: $(OBJ_RELEASE) $(DEP_RELEASE)
	$(LDFLAGS_RELEASE) $(LIBDIR_RELEASE) $(OBJ_RELEASE) $(LIB_RELEASE) -o $dynamic_output

$(OBJDIR_RELEASE)/DeviceInfo.o: DeviceInfo.cpp
	$(CFLAGS_RELEASE) $(INC_RELEASE) -c DeviceInfo.cpp -o $(OBJDIR_RELEASE)/DeviceInfo.o

$(OBJDIR_RELEASE)/GUIFrame.o: GUIFrame.cpp
	$(CFLAGS_RELEASE) $(INC_RELEASE) -c GUIFrame.cpp -o $(OBJDIR_RELEASE)/GUIFrame.o

$(OBJDIR_RELEASE)/LibreScribe.o: LibreScribe.cpp
	$(CFLAGS_RELEASE) $(INC_RELEASE) -c LibreScribe.cpp -o $(OBJDIR_RELEASE)/LibreScribe.o

$(OBJDIR_RELEASE)/src/BackgroundMonitor.o: src/BackgroundMonitor.cpp
	$(CFLAGS_RELEASE) $(INC_RELEASE) -c src/BackgroundMonitor.cpp -o $(OBJDIR_RELEASE)/src/BackgroundMonitor.o

$(OBJDIR_RELEASE)/src/Smartpen.o: src/Smartpen.cpp
	$(CFLAGS_RELEASE) $(INC_RELEASE) -c src/Smartpen.cpp -o $(OBJDIR_RELEASE)/src/Smartpen.o
